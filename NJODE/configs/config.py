...
# ------------------------------------------------------------------------------
# --- Renewal Process Classification
IO_RPClass_models_path = "{}saved_models_RPClassification/".format(data_path)
param_dict_IO_RPClass = {
    'epochs': [200],
    'batch_size': [200],
    'save_every': [50],
    'learning_rate': [0.001],
    ...
    'input_sig': [True],
    'level': [3],
    'data_dict': ['IO_RPClass_dict'],
    'test_data_dict': ['IO_RPClass_dict_test'],
    'which_loss': ['IO'],
    ...
    'paths_to_plot': [(0,1,2,3,4,)],
    'use_cond_exp': [True],
    'saved_models_path': [IO_RPClass_models_path],
}
param_list_IO_RPClass = get_parameter_array(param_dict=param_dict_IO_RPClass)

overview_dict_IO_RPClass = dict(
    ids_from=1, ids_to=len(param_list_IO_RPClass),
    path=IO_RPClass_models_path,
...
plot_paths_IO_RPClass_dict = {
    'model_ids': [2,], 'saved_models_path': IO_RPClass_models_path,
    'which': 'best',
    'paths_to_plot': [0,1,2,3,4],
    'ylabels': ['$A_t$', '$V_{t, 1}=1_{S_{t}=0}$', '$V_{t, 2}=1_{S_{t}=1}$'],
