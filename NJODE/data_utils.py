...
class PriorDataset(Dataset):
    """
    class for iterating over a prior dataset for generative process
    """
    def __init__(self, dataset_dict):
        
        self.idx = dataset_dict["idx"]
        self.stock_paths = dataset_dict["stock_path"]
        self.observed_dates = dataset_dict["observed_dates"]
        self.nb_obs = dataset_dict["nb_obs"]
        self.obs_noise = dataset_dict["obs_noise"]
        self.dt = dataset_dict["dt"]
    ...
    def __getitem__(self, idx):
        ...
        return {"idx": idx, "stock_path": self.stock_paths[idx], 
                "observed_dates": self.observed_dates[idx], 
                "nb_obs": self.nb_obs[idx], "dt": self.dt,
                "obs_noise": obs_noise}
# ********************************************************************************
